              ...
              <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
                {chatMessages.map((msg) => (
                  <div key={msg.id} className={`flex flex-col max-w-[80%] ${msg.sender === 'user' ? 'self-end items-end' : 'self-start items-start'}`}>
                    ...
                    <div className={`p-4 rounded-2xl text-[13.5px] leading-relaxed shadow-md ${msg.sender === 'user' ? 'bg-gradient-to-r from-cyan-500 to-indigo-500 text-white rounded-tr-none whitespace-pre-line' : 'bg-slate-900/90 border border-slate-800 rounded-tl-none text-slate-100'}`}>
